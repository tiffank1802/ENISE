...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{image/image10.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{image/image11.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{image/image12.png}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{image/image15.png}
        \caption{}
        \label{fig:pignon}
    \end{minipage}
    \hspace{0.05\linewidth}
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{image/image14.png}
        \caption{}
        \label{fig:liaisonn}
    \end{minipage}
\end{figure}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.48\linewidth}
        ...
        \caption{Description image/image 1}
        \label{fig:image/image1}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Screenshot 2025-12-12 at 20.28.56.png}
        \caption{Description image/image 2}
        \label{fig:image/image2}
    \end{minipage}
\end{figure}
...
\subsection{Avantages \& Iconvennients de chaque solution}


\subsection{Solution retenue}

La solution retenue correspond à la combinaison des modifications présentées précédemment.  
Ce choix a été effectué en tenant compte de plusieurs critères : le coût de fabrication, la durabilité et la résistance de l’axe face aux efforts appliqués, ainsi que le temps de production et la simplicité de réalisation.
